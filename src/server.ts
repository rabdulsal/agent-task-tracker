...
app.get("/setup",            async (req, reply) => reply.sendFile("setup.html"));
app.get("/wordmark-preview", async (req, reply) => reply.sendFile("wordmark-preview.html"));
...
const PUBLIC_PATHS = new Set(["/", "/docs", "/get-started", "/privacy", "/setup", "/wordmark-preview", "/health", "/waitlist"]);
